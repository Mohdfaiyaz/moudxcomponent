...
const { BaseCapgeminiHrFlow360PageCardView } = composeStories(DemoStories);

test('renders CapgeminiHrFlow360PageCardView', async () => {
  render(<BaseCapgeminiHrFlow360PageCardView />);
