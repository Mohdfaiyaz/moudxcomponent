...
const { BaseCapgeminiHrFlow360EmployeeInsight } = composeStories(DemoStories);

test('renders CapgeminiHrFlow360EmployeeInsight', async () => {
  render(<BaseCapgeminiHrFlow360EmployeeInsight />);
