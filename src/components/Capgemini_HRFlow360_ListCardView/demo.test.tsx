...
const { BaseCapgeminiHrFlow360ListCardView } = composeStories(DemoStories);

test('renders CapgeminiHrFlow360ListCardView', async () => {
  render(<BaseCapgeminiHrFlow360ListCardView />);
